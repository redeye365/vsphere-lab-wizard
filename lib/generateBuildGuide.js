...
function buildBuildGuide(spec) {
  ...
  out.push(`   - NTP: Configure Management Network → Custom DNS Suffixes → (then separately) Configure Management Network → NTP Configuration → Use the following NTP servers: \`${ntpSource}\``);
