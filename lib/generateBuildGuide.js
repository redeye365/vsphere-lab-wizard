...
function buildBuildGuide(spec) {
  ...
  if (spec.learningMode) {
    ...
    if (spec.useCase === 'certification') {
      ...
      out.push('');
      const objectives = ['VCP-DCV — ESXi and vCenter deployment and configuration'];
      if (nc.vsanEnabled) objectives.push('VCP-DCV — vSAN cluster configuration and management');
      ...
      if (spec.vcf && spec.vcf.enabled) objectives.push('VCF — management domain bring-up and SDDC Manager operations');
